...
const SingleHouse = () => {
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <div className='side '>
    <img src='https://d5t4h5a9.rocketcdn.me/wp-content/uploads/2021/04/Website-Photo-18.png' className='profile' />
    <h4>James Carter</h4>
    <p className='btn btn-outline-info'><i className="fas fa-phone"></i>Show Phone No.</p>
    <img src='https://prppublicstore.blob.core.windows.net/live-za-images/offices/6742/image/7807a79159fd4be68628f2c1dc7c121b_osm.jpg' className='img-fluid'/>
